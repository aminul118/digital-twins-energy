...
const ContactUs: React.FC = () => {
  return (
    <div className="relative px-4 sm:px-6 lg:px-12 py-6 lg:py-12 2xl:py-24 bg-cover bg-center bg-[url('/assets/background/contact.jpg')] dark:bg-none dark:bg-slate-900">
