...
const ContactUs: React.FC = () => {
  return (
    <div className="relative px-4 sm:px-6 lg:px-12 py-6 lg:py-12 2xl:py-24 min-h-[calc(100vh-276px)] bg-[url('/assets/background/contact.jpg')] bg-cover bg-center bg-opacity-50">
